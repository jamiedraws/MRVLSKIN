        ...
        <div class="hero__group">
            <div class="hero__offer-price-payment">
                ...
                <div class="hero__offer-price">
                  <div class="banner">
                      <span class="banner__slant">Special <strong class="banner__accent">TODAY ONLY</strong> Introductory Offer!</span>
                  </div>
                  <small>For the First 500 Orders</small>
                  <div class="hero__offer-retail">
                      Retail Price: $195
                  </div>
                  <div class="hero__offer-callout">
                      <span>Now Only $95 + Free Shipping</span>
                      <em>TOTAL SAVINGS OVER 70%</em>
                  </div>
                </div>
            ...
            <div class="hero__product-celebrity">
                <div class="hero__group">
                    <picture class="hero__product">
                        ...
                        <img src="/images/product.png" width="152" height="557" alt="MRVL&reg; Anti-Aging Firming Serum with Blue Scorpion Peptide">
                    </picture>
                    <div class="hero__bonus">
                        <picture>
                            <source srcset="/images/eye-cream.webp" type="image/webp" />
                            <img src="/images/eye-cream.png" width="168" height="189" alt="MRVL&reg; Super Rich Eye Cream">
                        </picture>
                        <div class="hero__stacked-banner banner-stacked">
                            <div class="banner">
                                <span class="banner__slant banner__slant--reverse"><strong class="banner__accent">FREE BONUS</strong></span>
                            </div>
                            <div class="banner">
                                <span class="banner__slant banner__slant--reverse">$180 VALUE</span>
                            </div>
                        </div>
                    </div>
...
<section aria-label="MRVL Offers" class="view product-details section">
    <div id="offers" class="view__anchor"></div>
    <div class="view__in product-details__in section__in">
        <h3>Order today &amp; you&rsquo;ll receive:</h3>
        <ul>
            <li>Anti-Aging Firming Serum 1.0oz (60 day supply, when used once daily)</li>
            <li><strong class="callout">FREE $180 Value</strong> Super Rich Eye Cream</li>
        </ul>
        ...
        <p>The ultimate Anti-Aging Firming Serum with Ubisome Q10 P1 to firm, lift, and reduce the look of wrinkles through collagen and elastin biosynthesis. Ubisome Q 10 P1 generates energy to the skin in order to assist with the health, elasticity, and natural skin repair cycle.</p>
    </div>
</section>
            ...
            <div class="content__media">
                <div class="view media-player">
					...
					<div class="media-player__player">
						<div class="media-player__video contain contain--video" data-media-player-src-iframe="https://player.vimeo.com/video/<%= firstVideo.Id %>?dnt=1" data-aspect-ratio="630/354" data-attr='{ "width": "630", "height": "354", "allow": "fullscreen", "title": "MRVL&reg;" }'></div>
						<%
...
<section aria-label="Featured in these magazines" class="view content content--base-light-bg content--logo-gallery section">
...
<section aria-labelledby="real-people-title" class="view content content--media-slider section">
    <div id="results" class="view__anchor"></div>
    <div class="view__in section__in">
        <div class="content__group">
            <header class="content__header">
                <h2 id="results-title" class="content__title"><span>REAL PEOPLE.</span> <span>REAL RESULTS!</span></h2>
                <p class="content__p">
                    Take a look at these amazing results from some of our satisfied customers.<br>
                    This introductory offer won&rsquo;t last long, get your MRVL&reg; SKIN SOLUTIONS Products today!
                </p>
            </header>
            <div class="content__slider">
                <div class="slide slide--fade slide--before-after slide--no-scrollbar" tabindex="0">
                    <div id="before-after" class="slide__into">
                        <div class="slide__item">
                            <div class="before-after">
                                <figure class="before-after__item">
                                    <picture class="content__picture" data-src-img="/images/before-after/before-1.jpg">
                                        <img src="/shared/images/blank.png" width="259" height="346" alt="Before using MVRL&reg;"/>
                                    </picture>
                                    <figcaption>Before</figcaption>
                                </figure>
                                <ol class="before-after__list">
                                    <li>Dark circles reduced</li>
                                    <li>Appearance of freckles and red-toned skin improved</li>
                                    <li>Smile creases now smoother</li>
                                </ol>
                                <figure class="before-after__item">
                                    <picture class="content__picture" data-src-img="/images/before-after/after-1.jpg">
                                        <img src="/shared/images/blank.png" width="259" height="346" alt="After using MVRL&reg;"/>
                                    </picture>
                                    <figcaption>After MRVL&reg;</figcaption>
                                </figure>
                            </div>
                        </div>
                        <div class="slide__item">
                            <div class="before-after">
                                <figure class="before-after__item">
                                    <picture class="content__picture" data-src-img="/images/before-after/before-2.jpg">
                                        <img src="/shared/images/blank.png" width="259" height="346" alt="Before using MVRL&reg;"/>
                                    </picture>
                                    <figcaption>Before</figcaption>
                                </figure>
                                ...
                                <figure class="before-after__item">
                                    <picture class="content__picture" data-src-img="/images/before-after/after-2.jpg">
                                        <img src="/shared/images/blank.png" width="259" height="346" alt="After using MVRL&reg;"/>
                                    </picture>
                                    <figcaption>After MRVL&reg;</figcaption>
                                </figure>
                        ...
                        <div class="slide__item">
                            <div class="before-after">
                                <figure class="before-after__item">
                                    <picture class="content__picture" data-src-img="/images/before-after/before-3.jpg">
                                        <img src="/shared/images/blank.png" width="259" height="346" alt="Before using MVRL&reg;"/>
                                    </picture>
                                    <figcaption>Before</figcaption>
                                </figure>
                                ...
                                <figure class="before-after__item">
                                    <picture class="content__picture" data-src-img="/images/before-after/after-3.jpg">
                                        <img src="/shared/images/blank.png" width="259" height="346" alt="After using MVRL&reg;"/>
                                    </picture>
                                    <figcaption>After MRVL&reg;</figcaption>
                                </figure>
    ...
    <div class="view__in section__contain">
        <div class="content__card">
            <header class="content__header">
                ...
                <p>THE MOST SKIN-TRANSFORMATIVE DISCOVERY IN A DECADE</p>
            </header>
