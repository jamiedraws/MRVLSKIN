...
<%
    ...
    var logoTemplate = @"<a href=""{0}"" class=""logo-text__group"">
        <svg class=""logo-text__logo"" aria-label=""{1}""><use href=""#logo"" /></svg>
    </a>";
    var logo = string.Format(logoTemplate, logoLink, productName);
%>

<svg class="svg-symbols">
<symbol id="logo" viewBox="0 0 2970.13 679.21">
  <defs>
    <style>
        #logo path {
            fill: currentColor;
...
<header aria-labelledby="header-title" class="view header section @print-only-hide">
    ...
    <div class="view__in section__in">
        <div class="header__group">
            ...
            <div id="header-title" class="header__title">CLINICALLY-PROVEN ANTI-AGING PEPTIDE TO HELP CORRECT SUN DAMAGED SKIN & HELP REPAIR YEARS OF AGING</div>
        </div>
    </div>
</header>
...
<nav id="nav" aria-label="Website pages links" class="view nav section @print-only-hide">
    <div class="view__in nav__group nav__in section__in">
        ...
        <div aria-label="Website page links" class="nav__pane">
