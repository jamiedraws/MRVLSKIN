...
<link rel="preload" href="/css/2.0000/shell.css<%= v %>" as="style">
<link rel="stylesheet" href="/css/2.0000/shell.css<%= v %>">

<% if (DtmContext.Page.IsStartPageType) { %>
    <link rel="preload" href="/css/2.0000/index.css" as="style">
    <link rel="stylesheet" href="/css/2.0000/index.css">
<% } %>

<% if (!DtmContext.Page.IsStartPageType) { %>
    <link rel="preload" href="/css/2.0000/dtm.css<%= v %>" as="style"/>
    <link rel="stylesheet" href="/css/2.0000/dtm.css<%= v %>" />
<% } %>

<script defer src="/js/2.0000/app.es5.js<%= v %>"></script>
